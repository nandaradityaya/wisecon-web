                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="edit-key-features-container">
                                            ...
                                            @empty
                                                <input type="text" class="form-control mb-2" placeholder="Key Features..." name="key_features[]">
                                            @endforelse
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="edit-our-approachess-container">
                                            ...
                                            @empty
                                                <input type="text" class="form-control mb-2" placeholder="Our Approach..." name="our_approaches[]">
                                            @endforelse
                                        </div>
